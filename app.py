...
def index():
    ...
    if request.method == 'GET':
        ...
        headers = {'POST https://api.ticketutils.com/POS/v3.1/Tickets','X-Signature':'UUkIadAHSyOBVFUYslm9YWxNeAWGkyxgXtPdUNAcJOs=','X-Token':'4644945949495429116','Content-Type':'application/json'}
        res = None
