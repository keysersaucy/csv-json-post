...
def middleware_factory():
    def nest(data):
        for row in data:
            if 'Consignment.Operation' in row and if 'Consignment.Commission' in row and if 'Shipping.Cost' in row and if 'Shipping.TrackingNumber' in row and if 'Shipping.Service' in row and if 'Shipping.Carrier' in row and if 'Shipping.Type' in row and if 'Shipping.DateExpected' in row and if 'Shipping.Note' in row and if 'PurchaseOrder.Currency' in row and if 'PurchaseOrder.PODate' in row and if 'PurchaseOrder.ShipFromContactId' in row and if 'PurchaseOrder.BillToAddressId' in row and if 'PurchaseOrder.ShipToAddressId' in row and if 'PurchaseOrder.VendorCSRId' in row and if 'PurchaseOrder.POType' in row and if 'PurchaseOrder.ExternalOrderNumber' in row and if 'PurchaseOrder.Notes' in row and if 'PurchaseOrder.IsShippingCostIncludedinTicketPrice' in row and if 'SpecOption.ExpirationType' in row and if 'SpecOption.ExpirationDate' in row and if 'SpecOption.ExpirationDays' in row and if 'TicketSeats.Seat' in row and if 'TicketSeats.Barcode' in row and if 'TicketSeats.ReferenceNumber' in row and if 'SplitOptions.SplitOption' in row and if 'SplitOptions.Splits' in row and if 'SplitOptions.OverrideSplitOption' in row and if 'InHandDetails.InHandStatus' in row and if 'InHandDetails.InHandDays' in row and if 'InHandDetails.InHandDate' in row and if 'FacePrice.Currency' in row and if 'FacePrice.Amount' in row and if 'PurchasePrice.Currency' in row and if 'PurchasePrice.Amount' in row and if 'SellPrice.Currency' in row and if 'SellPrice.Amount' in row and if 'Tickets.SHEventId' in row and if 'Tickets.EventId' in row and if 'Tickets.VenueId' in row and if 'Tickets.Event' in row and if 'Tickets.EventDate' in row and if 'Tickets.Venue' in row and if 'Tickets.Section' in row and if 'Tickets.Row' in row and if 'Tickets.Quantity' in row and if 'Tickets.MaskedQuantity' in row and if 'Tickets.DoNotWaste' in row and if 'Tickets.Seating' in row and if 'Tickets.Stock' in row and if 'Tickets.SHDeliveryMethod' in row and if 'Tickets.PredeliverToSH' in row and if 'Tickets.PublicNotes' in row and if 'Tickets.InternalNotes' in row and if 'Tickets.BrokerNotes' in row and if 'Tickets.ControlNotes' in row and if 'Tickets.DeliveryOption' in row and if 'Tickets.ReferenceNumber' in row and if 'Tickets.Discount' in row and if 'Tickets.Overs' in row and if 'Tickets.Tax' in row and if 'Tickets.Tags' in row and if 'Tickets.MinimumPayout' in row and if 'Tickets.HideSeats' in row and if 'Tickets.ZonePricing' in row and if 'Tickets.Location' in row and if 'Zones.ZoneCode' in row and if 'Zones.Broadcast' in row and if 'Broadcast.BroadcastTo' in row:
